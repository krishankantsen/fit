...
export async function generateMetadata({ params }: ProjectPageProps) {
  ...
  return {
    title: `${project.title} | Portfolio | Zenith Architecture`,
...
export default async function ProjectDetailPage({ params }: ProjectPageProps) {
  ...
  const completionDate = new Date(project.completion_date).toLocaleDateString('en-US', {
    year: 'numeric',
    month: 'long',
  });
  ...
  return (
    <main>
      <HeroSection
        ...
        subtitle="Project"
        description={project.description}
        backgroundImage={project.image_urls?.[0] || 'https://images.pexels.com/photos/1454360/pexels-photo-1454360.jpeg'}
      />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12 p-8 bg-gray-50 rounded-lg">
            ...
            <div>
              <div className="flex items-center text-gray-600 mb-2">
                ...
                <span className="text-sm font-semibold uppercase">Project Size</span>
              </div>
              <p className="text-lg font-bold text-gray-900">{project.project_size}</p>
            </div>
            <div>
              <div className="flex items-center text-gray-600 mb-2">
            ...
            <div className="mb-12 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-red-50 p-8 rounded-lg border border-red-200">
                ...
                <ul className="space-y-3">
                  {project.challenges_solutions.challenges?.map((challenge: string, idx: number) => (
              ...
              <div className="bg-green-50 p-8 rounded-lg border border-green-200">
                ...
                <ul className="space-y-3">
                  {project.challenges_solutions.solutions?.map((solution: string, idx: number) => (
                    <li key={idx} className="flex items-start">
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-blue-100 mb-8">
            Get in touch with our team to discuss your vision and how we can help make it a reality.
          </p>
